    ...
    st.markdown(
        ...
        <p style="margin-bottom: 10px;">
            <a href="https://www.linkedin.com/in/jannekeclever/" target="_blank" style="text-decoration: none; color: black;">
                <img src="https://img.icons8.com/ios-filled/50/000000/linkedin-circled.png" width="25" height="25" style="vertical-align: middle;" />
                LinkedIn
            </a>
        </p>
        <p>
            <a href="mailto:jannekemorin@gmail.com" style="text-decoration: none; color: black;">
                <img src="https://img.icons8.com/ios-filled/50/000000/mail.png" width="25" height="25" style="vertical-align: middle;" />
                Email
            </a>
        </p>
        """,
